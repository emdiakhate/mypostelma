-- Corriger la fonction get_user_quotas pour utiliser les bons noms de colonnes
...
BEGIN
  SELECT 
    ...
    COALESCE(ai_image_generation_limit, 15) as ai_image_limit,
...
-- Corriger la fonction increment_ai_image_generation
...
-- Corriger la fonction increment_ai_video_generation
...
-- Corriger la fonction reset_user_quotas
