...
CREATE INDEX idx_conversation_teams_conversation ON conversation_teams(conversation_id);
CREATE INDEX idx_conversation_teams_team ON conversation_teams(team_id);
...
CREATE INDEX idx_message_ai_analysis_message ON message_ai_analysis(message_id);
CREATE INDEX idx_message_ai_analysis_conversation ON message_ai_analysis(conversation_id);
...
COMMENT ON TABLE teams IS 'Teams for organizing message routing (RH, Creators, etc.)';
COMMENT ON TABLE team_members IS 'Members of each team, can be invited by email';
COMMENT ON TABLE conversation_teams IS 'Links conversations to teams via AI routing or manual assignment';
COMMENT ON TABLE message_ai_analysis IS 'Logs of AI analysis for message routing';
