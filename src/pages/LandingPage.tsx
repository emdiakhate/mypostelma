            ...
            <div className="flex gap-12 animate-scroll">
              ...
              <div className="flex gap-12 items-center shrink-0">
                ...
                <div className="flex items-center gap-3 transition-all">
                  ...
                  <span className="text-lg font-semibold text-gray-700 whitespace-nowrap">Instagram</span>
                </div>
                ...
                <div className="flex items-center gap-3 transition-all">
                  ...
                  <span className="text-lg font-semibold text-gray-700 whitespace-nowrap">Facebook</span>
                </div>

                {/* LinkedIn */}
                <div className="flex items-center gap-3 transition-all">
                  <Linkedin className="w-8 h-8 text-blue-700" />
                  <span className="text-lg font-semibold text-gray-700 whitespace-nowrap">LinkedIn</span>
                </div>

                {/* X/Twitter */}
                <div className="flex items-center gap-3 transition-all">
                  <Twitter className="w-8 h-8 text-black" />
                  <span className="text-lg font-semibold text-gray-700 whitespace-nowrap">X</span>
                </div>
                ...
                <div className="flex items-center gap-3 transition-all">
                  ...
                  <span className="text-lg font-semibold text-gray-700 whitespace-nowrap">TikTok</span>
                </div>
                ...
                <div className="flex items-center gap-3 transition-all">
                  ...
                  <span className="text-lg font-semibold text-gray-700 whitespace-nowrap">YouTube</span>
                </div>
                ...
                <div className="flex items-center gap-3 transition-all">
                  ...
                  <span className="text-lg font-semibold text-gray-700 whitespace-nowrap">Pinterest</span>
                </div>
              </div>

              {/* Deuxième set de logos (pour le défilement infini - copie exacte) */}
              <div className="flex gap-12 items-center shrink-0">
                {/* Instagram */}
                <div className="flex items-center gap-3 transition-all">
                  <Instagram className="w-8 h-8 text-pink-500" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 mt-16">
            {[
              ...
              },
              {
                ...
                description: 'Comprenez l\'engagement de votre audience avec analyse IA des commentaires et réactions',
                features: ['Sentiment positif/neutre/négatif', 'Mots-clés récurrents', 'Taux de réponse', 'Statistiques hebdo']
              },
              {
                icon: <TrendingUp className="w-8 h-8 text-cyan-600" />,
                iconBg: "bg-cyan-100",
                title: 'Analyse Concurrentielle',
                description: 'Surveillez vos concurrents avec scraping IA multi-plateformes et rapports détaillés',
                features: ['Scraping posts', 'Analyse de ton', 'Métriques engagement', 'Opportunités identifiées']
              },
              {
