          ...
          <div>
            {showAddInput ? (
              ...
              <Button 
                variant="outline" 
                size="sm" 
                className="w-full border-dashed border-purple-300 text-purple-800 hover:bg-purple-50 dark:border-purple-700 dark:text-purple-400 dark:hover:bg-purple-900/20"
                onClick={() => setShowAddInput(true)}
              >
                <Plus className="w-4 h-4 mr-2" />
                Créer un hashtag personnel
              </Button>
            )}
          </div>
        </div>
